      ...
      <div class="flex justify-center items-center h-screen">
        <div class="max-w-md mx-auto">
          <select v-model="selected_user_id"
            class="w-full mb-4 px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring focus:ring-blue-500">
          ...
          <button @click="selectUser"
            class="block w-full px-4 py-2 rounded-lg text-white bg-blue-500 hover:bg-blue-600 focus:outline-none focus:ring focus:ring-blue-500">
            Next
          </button>
        </div>
      </div>
    ...
    <div v-else>
      ...
      <div class="mb-4 mt-4 float-right">
        <button @click="showTaskForm = true"
          class="px-4 py-2 rounded-lg text-white bg-green-500 hover:bg-green-600 focus:outline-none focus:ring focus:ring-green-500">
          Add Task
        </button>
      </div>
      <table class="w-full border-collapse border border-gray-300 text-center">
        ...
        <tbody v-if="!isTableLoading">
          <tr v-for="task in selected_user_tasks" :key="task.id">
            ...
            <td class="px-4 py-2">
              <button v-if="task.end_time !== null" @click="endTask(task)"
                class="px-4 py-2 rounded-lg text-white bg-red-500">
                Stop
              </button>
              <button v-else @click="startTask(task)"
                class="px-4 py-2 rounded-lg text-white bg-blue-500 hover:bg-blue-600 focus:outline-none focus:ring focus:ring-blue-500">
                Start
              </button>
      ...
      <div v-if="showTaskForm"
        class="fixed top-0 left-0 w-full h-screen bg-gray-500 bg-opacity-50 flex justify-center items-center">
        <div class="bg-white rounded-lg shadow-lg p-8">
          ...
          <form @submit.prevent="addTask">
            <div class="mb-4">
              ...
              <input v-model="newTask.title"
                class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring focus:ring-blue-500"
          ...
          <button @click="showTaskForm = false"
            class="absolute top-0 right-0 px-2 py-1 text-gray-700 hover:text-gray-900 focus:outline-none">
